...
all_df = pd.read_csv("./dashboard/allData.csv")
...
sns.barplot(x=rating_scores.index, y=rating_scores.values, hue=rating_scores.values, legend=False, palette="viridis")
...
sns.barplot(x='review_score', y='product_category_name', data=product_ratings, hue='product_category_name', legend=False, palette="plasma")
...
st.caption('Copyright (C) Diajeng Mahai Sukma - Project Dicoding. 2024')